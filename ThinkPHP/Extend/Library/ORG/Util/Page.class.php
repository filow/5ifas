...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'&lt;&lt;','next'=>'&gt;&gt;','first'=>'|&lt;','last'=>'&gt;|','theme'=>' %first%  %prePage%  %upPage%   %linkPage%  %downPage%  %nextPage%  %end% ');
    // 默认分页变量名
    protected $varPage;
    ...
    public function show() {
        ...
        if($nowCoolPage == 1){
            ...
            $prePage    =   "<li><a href='".str_replace('__PAGE__',$preRow,$url)."' >&lt;".$this->rollPage."</a></li>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage   =   "<li><a href='".str_replace('__PAGE__',$nextRow,$url)."' >&gt;".$this->rollPage."</a></li>";
        ...
        $pageStr="<div class=\"pagination pagination-large\"><ul>".$pageStr."</ul></div>";
        return $pageStr;
    }
